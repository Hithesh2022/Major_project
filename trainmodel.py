...
classifiers = [('Decision Tree', dtree), ('KNN', knn)]
...
pred = ensemble_classifier.predict(X_t)
...
print("Ensemble Classifier - Accuracy:", round(accuracy, 3))

joblib.dump(ensemble_classifier, 'newtrainedModel.joblib')